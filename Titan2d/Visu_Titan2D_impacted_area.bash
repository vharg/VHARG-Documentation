...
#1 Impacted area (generated by Convert_tecplot_loop.bash)
echo -n "input impacted-area file (junk) (no extension):"
read deposit

echo -n "input single tecplot file (tecpl0000003758)(last one created):"
read NAME
...
makecpt -Crainbow -T0.5/20/2 -V > deposit_thicknes.cpt
...
#grdcontour /Users/elly/Documents/HazardModelling/Titan_2D/TestVisualisation/Gede_UTM.tif -JX -R -O -C500 -Ba5000g1000:"":/a5000g1000:.:SWne -K  >> $NAME.ps
...
#11 plot in overlay map: impacted area in defined color scale
#awk '($3>=0.5) {print $1,$2,$3}' $deposit.dat | psxy -Sc0.05 -Clava.cpt -V -R -JX -K -O >> $NAME.ps
#awk '($3>=0.5) {print $1,$2,$3}' $deposit.dat | psxy -Sc0.05 -Cdeposit_thicknes.cpt -V -R -JX -K -O >> $NAME.ps
awk '($3>=0.5) {print $1,$2,$3}' $deposit.dat | psxy -Sc0.05 -Cdeposit_thicknes.cpt -V -R -JX -K -O >> $NAME.ps

#12 plot in overlay map: deposit thickness from selected tecplot file, in defined color scale
...
#13 Plot initial source ellipsoid
#psxy -JX -R -Se -W2/255/0/0 -O -V -K <<END>> $NAME.ps
#433300 349700 120 .09 .045


#14 plot color scale as legend
psscale -Clava.cpt -D18/8/16/0.4 -L -B::/:m: -U"$NAME" -O >> $NAME.ps

#15 convert postcript file to .jpg
